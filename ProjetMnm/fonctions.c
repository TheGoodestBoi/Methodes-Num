...
void SOR(int n, double A[n][n], double x[n], double b[n]) {
...
double w = 1.9;
double residu[n];                      // On fixe la valeur de omega
...
do {
    ...
    SOR(n, A, v, x);                    //                                                  SOR MODE
    resol_trig_inf(n, Low, y, x);       // Résolution du système décomposé                  LLT MODE
    resol_trig_sup(n, Up, v, y);        //                                                  LLT MODE
